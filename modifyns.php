  ...
  <div id="school_wrapper">
    ...
    <div id="school_main">
	  ...
	  <br/></br>
        <?php 
 $id=$_REQUEST['id'];
$sel=mysqli_query($conn,"SELECT * FROM nonstaff WHERE NONS_ID=$id");
...
$insert= mysqli_query($conn,"UPDATE nonstaff SET NAME='$fname', DUTY='$role', SEX='$sex', AGE='$age', STATUS='$status' WHERE NONS_ID=$id");
