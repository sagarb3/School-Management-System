  ...
  <div id="school_wrapper">
    ...
    <div id="school_main">
	  ...
	  <br/></br>
        <?php 
 $id=$_REQUEST['id'];
$sel=mysqli_query($conn,"SELECT * FROM payments WHERE STUDENT_ID=$id");
...
$sel=mysqli_query($conn,"select TUTION from payments where STUDENT_ID=$id");
$tut=mysqli_fetch_array($sel);
$tution= $tut['TUTION'];
echo $id.'<br>';
echo $tution.'<br>';
...
$insert= mysqli_query($conn,"UPDATE payments SET STNAME='$fname',CLASS='$class', TERM='$term', YEAR='$year',
