  ...
  <div id="school_wrapper">
    ...
    <div id="school_main">
	  ...
	  <br/></br>
        <?php 
 $id=$_REQUEST['id'];
$sel=mysqli_query($conn,"SELECT * FROM teacher WHERE TEACH_ID='$id'");
...
$insert= mysqli_query($conn,"UPDATE teacher SET NAMES='$fname', SEX='$sex', AGE='$age', QUALITY='$ua' ,STATUS='$status' WHERE TEACH_ID='$id'") or die(mysqli_query());
